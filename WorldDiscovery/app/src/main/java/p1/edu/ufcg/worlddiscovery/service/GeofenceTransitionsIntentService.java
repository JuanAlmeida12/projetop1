...
public class GeofenceTransitionsIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER ||
            ...
            for (Geofence geo : triggeringGeofences) {
                sendNotification(geo.getRequestId());
            }
    ...
    private void sendNotification(final String notificationDetails) {
        ...
        final Point point = GeofenceUtils.getBindingPoint(notificationDetails);
        Log.d("gg", notificationDetails);
        if (null != point) {

            Log.d(TAG, "não null: " + point.placeName
            );
            ...
            //ActivitiesUtils.newActivity(ActivitiesUtils.ACTIVITY_NEW_PLACE);

            //PointUtils.visitedPoint(notificationDetails);
        }
    }
